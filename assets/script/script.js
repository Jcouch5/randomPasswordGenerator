...
var all = lowerUpperNum.concat(specialChars);
var lowerNum = lowerCase.concat(number);
var lowerSpecial = lowerCase.concat(specialChars);
var lowerUpperSpecial = lowerUpper.concat(specialChars);
var upperNum = upperCase.concat(number);
var upperSpecial = upperCase.concat(specialChars);
var upperNumSpecial = upperNum.concat(specialChars);
var numberSpecial = number.concat(specialChars);
...
function generatePassword() {
  ...
  for (i=0; i < chars; i++) {
    if(lower && upper && num && specialChar){
      ...
      password += specialChars[randomNum];
    }
  }
